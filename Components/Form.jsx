      ...
      <div className="flex items-center min-h-screen px-4 py-8">
        <div className="relative W-full p-4 mx-auto bg-white rounded-md shadow-lg">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            Ut enim ad minim veniam, quis nostrud exercitation ullamco tabori nisi ut aliquip ex ea commodo consequat.
            </p>
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <div className=" relative mt-3">
                <input
                  ...
                  className="pw-full pl-5 pr-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                  onChange={(e) =>
                    setShipment({
                      ...shipment,
